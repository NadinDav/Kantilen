    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Редактирование награды</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item active">Редактирование награды "{{$award->title}}"</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        <form action="{{route('admin.award.update', $award->id)}}" method="post"
                            ...
                            <div class="form-group w-50">
                                ...
                                <div class="w-25 mb-2">
                                    <img src="{{ asset('storage/' . $award->award)}}" alt="image"
                                         class="w-50">
                                </div>
